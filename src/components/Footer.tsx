...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      { name: "التوصيل المحلي", path: "/services/local" },
      { name: "توصيل الطرود", path: "/services/packages" },
      { name: "توصيل المشتريات", path: "/services/shopping" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">توصيل</span>
            </div>
            <p className="text-gray-400 mb-4">
              خدمة توصيل سريعة وموثوقة لجميع احتياجاتك. نغطي جميع مناطق المدينة بأسعار منافسة وخدمة عملاء متميزة.
            </p>
